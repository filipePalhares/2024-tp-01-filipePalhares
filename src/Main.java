public class Main {
    public static void main(String[] args) {
        ...
        Cliente joao = Cliente.criarCliente("João", "111.111.11-11", "Av. Antonio Carlos, 6627", 36, 'm');

        if(joao == null)
        {
            System.out.println("Nao foi possivel criar o cliente");
            return;
        }
        else System.out.println("Nao foi possivel criar o cliente");
